...
import com.gitandroid.databinding.EventStarredItemBinding

class EventAdapter : ListAdapter<GitEvents, EventAdapter.EventsViewHolder>(DiffCallBack()){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventsViewHolder {
        val binding = EventStarredItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class EventsViewHolder(val binding: EventStarredItemBinding) : RecyclerView.ViewHolder(binding.root) {
